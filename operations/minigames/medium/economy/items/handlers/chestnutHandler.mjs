...
export default class ChestnutHandler {
    ...
    static async use(interaction, user) {
        try {
            ...
            // // Add feedback.
            // const feedbackText = `${user.username} used chestnut and ${succeeded ? 'successfully' : 'potentially'} triggered woodcutting trees!`;
    
            // // Create record
            // COOP.CHANNELS._send('ACTIONS', feedbackText);
    
            // Reply to interaction
            const feedbackText = "Chestnut handler work in progress.";
